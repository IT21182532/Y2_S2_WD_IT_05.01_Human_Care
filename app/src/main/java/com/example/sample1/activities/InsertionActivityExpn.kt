...
class InsertionActivityExpn : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_insertionexpn)
...
//        }
        ...
        btnFetchData.setOnClickListener{
            val intent = Intent(this, FetchingActivityExpn::class.java)
            startActivity(intent)
        }
    ...
    private fun saveEmployeeData() {
        ...
        val employee = ExpenceModel(REQ1,REQ2,REQ3, REQ4,REQ5, REQ6 )
